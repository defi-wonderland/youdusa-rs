...
"function test_prop_anyoneCanIncreaseFundInAPool() public {
    ...
    this.prop_alloOwnerCanAlwaysChangePercentFee{ value: 0 }(15056796);

    vm.roll(34180);
    vm.warp(321741);
    vm.prank(0x0000000000000000000000000000000000070000);
    this.prop_anyoneCanIncreaseFundInAPool{ value: 0 }(13441534537036768485200417184756697876915712920751763869415731560796441041418, 334437,'');

    vm.roll(34180);
    vm.warp(321741);
    vm.prank(0x0000000000000000000000000000000000070000);
    this.prop_tryThisNow{ value: 0 }(13441534537036760751763869415731560796441041418, 334437, (123,''), (0x123, 69),'');
...
function test_prop_anyoneCanIncreaseFundInAPool2() public {
    ...
    vm.warp(321741);
    vm.prank(0x0000000000000000000000000000000000070000);
    this.prop_anyoneCanIncreaseFundInAPool{ value: 0 }(23, 334437, (1, 2),'');
